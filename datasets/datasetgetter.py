...
def get_dataset(dataset, args):
    ...
    elif dataset.lower() == 'font':
        print('use dataset of %s' % dataset)
        print("LABEL MAP:", remap_table)

        img_dir = os.path.join(args.data_dir, dataset)
        train_dataset = ImageFolerRemap(img_dir, transform=transform, remap_table=remap_table)
        val_dataset = ImageFolerRemap(img_dir, transform=transform_val, remap_table=remap_table)
